...
# 资源表
class Path(Base):
    pic = models.CharField(max_length=225, verbose_name='图片')
    path = models.CharField(max_length=50, verbose_name='路劲名称')
    info = models.CharField(max_length=220, verbose_name='路径简介')
...
class Course(Base,models.Model):
    ...
    info = models.CharField(max_length=220)    # 课程简介
    ...
    recommand = models.IntegerField()         #课程推荐
    detail = models.CharField(max_length=255)  # 课程详情
    section_num = models.IntegerField()    #章节数
    original_price = models.DecimalField(max_digits=8, decimal_places=2, default=999999.99)
    # price = models.DecimalField(max_digits=8, decimal_places=2, default=999999.99)  # 课程原价
    class Meta:
        db_table = 'Course'
...
class Price(Base,models.Model):
    ...
    discoun_price = models.DecimalField(max_digits=8,decimal_places=2)   #折扣价
...
class Coupon(Base):
    ...
    end_time = models.DateTimeField()
    status = models.IntegerField()
    condition = models.DecimalField(max_digits=8,decimal_places=2)
